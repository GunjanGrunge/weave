// Duplicated byte-for-byte in src/lib/polish-aspects.ts. There is no shared
// workspace between the functions/ package and the frontend, and this list
// is small, stable, curated data — the same tradeoff Story 1.3 made for
// style presets (functions/src/config/stylePresets.ts / src/lib/style-presets.ts),
// deferred there as acceptable rather than building shared-package tooling.
